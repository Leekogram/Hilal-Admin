...
// Initialize Cloud Storage and get a reference to the training
const storage = getStorage(app);
// Initialize Realtime Database and get a reference to the training
...
document.getElementById("trainingForm").addEventListener("submit", addProduct);
...
var inputField = document.getElementById("trainingName");
  ...
  getDocs(q)
    .then((querySnapshot) => {
      ...
      var matchingValues = querySnapshot.docs.map(function (doc) {
        console.log(doc.data().trainingName);
        return doc.data().trainingName;
      });
...
async function addtraining(
  ...
  await addDoc(collection(database, "training"), {
    ...
    .then((docRef) => {
      ...
      document.getElementById("success-alertMessage").innerHTML = `${trainingName} training was added successfully`;
    ...
    .catch((error) => {
      ...
      document.getElementById("failure-alertMessage").innerHTML = `An Error occured when adding ${trainingName}, please try again`;
